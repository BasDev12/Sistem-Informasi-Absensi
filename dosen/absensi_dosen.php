...
<head>
  ...
  <title>Absensi | STMIK Hasan Sulur Wonomulyo</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="mb-5 text-gray-800">Melakukan Absensi</h1>
          <div class="row">
            ...
            <div class="col-md-4 animated--fade-in">
              <div class="card shadow mb-4">
                ...
                <div class="collapse hide" id="absen">
                  <div class="card-body">
                    <form role="form" action="detailabsensi_dosen.php" method="get" name="postform" enctype="multipart/form-data">
            ...
            <div class="col-md-4">
              <div class="card shadow mb-4">
                ...
                <div class="collapse hide" id="rekap">
                  <div class="card-body">
                    <form role="form" action="rekapabsensi_dosen.php" method="get" name="postform" enctype="multipart/form-data">
                      <div class="form-group">
                        <label for="kelas">Kelas</label>
                        <select id="kelas" class="form-control" name="kelas">
                          <?php
