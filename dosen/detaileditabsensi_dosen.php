...
<head>
  ...
  <title>Edit Absensi | STTMIK HSW</title>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="dosen_dashboard.php">
        ...
        <div class="sidebar-brand-text mx-3">STMIK HSW</div>
      </a>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <h1 class="h3 mb-4 text-gray-800">Ubah Absensi </h1>
            <form role="form" action="editabsensi_dosen.php?kelas=<?php echo $id_kelas;?>&npm=<?php echo $npm;?>" method="post" name="postform" enctype="multipart/form-data">
			<?php
