...
<head>
  ...
  <title>Dashboard | STMIK HSW</title>
          ...
          <div class="row">
                ...
                <a href="lihatmhs.php" style="text-decoration:none;">
                  <div class="card-body">
                    <div class="row no-gutters align-items-center">
                      <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Data <br></div>
              ...
              <div class="card border-left-primary shadow h-100 py-2">
                <a href="lihatkelas.php" style="text-decoration:none;">
                  <div class="card-body">
                    <div class="row no-gutters align-items-center">
                      <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Data <br> </div>
                ...
                <a href="lihatmatkul.php" style="text-decoration:none;">
                  <div class="card-body">
                    <div class="row no-gutters align-items-center">
                      <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Data  <br> </div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800"> Matakuliah</div>
            ...
            <div class="col-xl-3 col-md-6 mb-4 ">
              <div class="card border-left-warning shadow h-100 py-2">
                <a href="lihatdsn.php" style="text-decoration:none;">
